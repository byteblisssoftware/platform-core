...
import { conversations, valaLogo } from "@/lib/connect-chat/chat-data";
  ...
  return (
    <main className="min-h-screen bg-background p-4 lg:p-8">
      <div className="mx-auto w-full max-w-6xl space-y-6">
        <header className="cglass flex flex-wrap items-center justify-between gap-4 rounded-3xl p-5 shadow-float">
        ...
        <section className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {kpis.map((k) => {
            const Icon = k.icon;
            return (
              <article key={k.label} className="cglass rounded-3xl p-5 shadow-3d">
        ...
        <section className="grid gap-4 lg:grid-cols-2">
          <article className="cglass rounded-3xl p-5 shadow-3d">
